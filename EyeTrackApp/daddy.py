...
class DADDY_cls(object):
    def __init__(self):
        ...
        ort_session = onnxruntime.InferenceSession(resource_path(model_file), sess_options=options, providers=["DmlExecutionProvider"])
        ort_session.set_providers(["DmlExecutionProvider"])  # only cpu mode
