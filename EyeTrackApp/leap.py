...
class LEAP_C(object):
    def __init__(self):
        ...
        # ort_session1 = onnxruntime.InferenceSession("C:/Users/%USERNAME%/Desktop/eyetracking/EyeTrackVR-2.0-beta-feature-branch-cpu/EyeTrackVR-2.0-beta-feature-branch/EyeTrackApp/Models/leap123023.onnx", opts, providers=['DmlExecutionProvider'])
        threads = []
